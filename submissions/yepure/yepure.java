...
public class yepure extends AbstractionLayerAI {
    ...
    // ─── CoS Config ───────────────────────────────────────────────────────────
    private static final int FRAME_QUEUE_SIZE = 5;  // K: frames to synthesize in L2
    private static final int LLM_INTERVAL     = 20; // ticks between L2 LLM calls
    // Action queue: how many ticks to reuse one L2 decision before refreshing
    // SC2 uses K frames per L2 call; we match this
    private static final int ACTION_QUEUE_TTL = 20;
